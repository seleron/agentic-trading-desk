...
class TestComputePivotRiskScore(unittest.TestCase):
    ...
    def test_below_s1_or_above_r1_no_credit(self):
        ...
        score, _ = compute_pivot_risk_score(
            close=85.0, pivot=100.0, r1=110.0, s1=90.0, r2=None, s2=None
        )
    ...
    def test_at_s1_edge_no_credit(self):
        ...
        score, _ = compute_pivot_risk_score(
            close=92.5, pivot=100.0, r1=110.0, s1=90.0, r2=None, s2=None
        )
    ...
    def test_above_pivot_below_r2_continuation(self):
        ...
        score, rationale = compute_pivot_risk_score(
            close=105.0, pivot=100.0, r1=110.0, s1=90.0, r2=120.0, s2=None
        )
    ...
    def test_above_pivot_below_r2_no_s1_r1_overlap(self):
        ...
        score, rationale = compute_pivot_risk_score(
            close=104.0, pivot=100.0, r1=110.0, s1=90.0, r2=130.0, s2=None
        )
        self.assertEqual(score, 5)  # +3 (safe zone) + +2 (continuation) = 5
        self.assertIn("Safely between S1 and R1", rationale[0])
        self.assertIn("bullish continuation zone", rationale[1])

    def test_r2_s2_both_populated(self):
        """When both r2 and s2 are populated, the +2 branch still fires correctly."""
        score, rationale = compute_pivot_risk_score(
            close=105.0, pivot=100.0, r1=110.0, s1=90.0, r2=130.0, s2=70.0
        )
        self.assertEqual(score, 5)
        self.assertIn("bullish continuation zone", rationale[1])
    ...
    def test_close_above_r2_no_continuation_credit(self):
        ...
        score, rationale = compute_pivot_risk_score(
            close=135.0, pivot=100.0, r1=110.0, s1=90.0, r2=130.0, s2=None
        )
    ...
    def test_close_at_r2_edge_no_continuation_credit(self):
        ...
        score, _ = compute_pivot_risk_score(
            close=127.0, pivot=100.0, r1=110.0, s1=90.0, r2=130.0, s2=None
        )
    ...
    def test_close_near_r2_with_safe_zone(self):
        ...
        score, rationale = compute_pivot_risk_score(
            close=126.0, pivot=100.0, r1=115.0, s1=85.0, r2=130.0, s2=None
        )
    ...
    def test_no_pivot_no_credit(self):
        ...
        score, rationale = compute_pivot_risk_score(
            close=105.0, pivot=None, r1=110.0, s1=90.0, r2=130.0, s2=None
        )
        self.assertEqual(score, 0)
    ...
    def test_close_just_above_pivot(self):
        ...
        score, rationale = compute_pivot_risk_score(
            close=100.5, pivot=100.0, r1=110.0, s1=90.0, r2=130.0, s2=None
        )
